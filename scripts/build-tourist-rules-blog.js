...
const articles = [
  {
    ...
    keywords: "cuanto cuesta tour islas del rosario 2026, precio tour islas del rosario cartagena, pasadia islas del rosario precio",
    category: "Precios 2026",
    categoryClass: "text-emerald-700",
    cardCategory: "normativa guia islas destacado",
    image: "images/islastour (2).webp",
    imageWidth: 1024,
    imageHeight: 767,
    ...
    sections: [
      ["Respuesta rápida: precio de un tour a Islas del Rosario", `<div class="tip-box"><p><strong>El precio depende del producto disponible, la fecha, la embarcación y los servicios incluidos. Consulta las opciones vigentes y pide el valor final antes de reservar.</p></div>`],
      ["Tabla de precios de referencia 2026", `<table><thead><tr><th>Experiencia</th><th>Desde</th><th>Enfoque</th></tr></thead><tbody><tr><td>Buceo y snorkel</td><td><strong>$250.000 COP</strong></td><td>Actividad acuática y arrecife</td></tr><tr><td>Pasadía Isla Lizamar</td><td><strong>$385.000 COP</strong></td><td>Instalaciones, piscina y almuerzo buffet</td></tr></tbody></table><p>Compara las fichas actualizadas en nuestra <a href="../../experiences.html">página de experiencias en Cartagena</a>.</p>`],
    ...
    faqs: [
      ["¿Cuánto vale un pasadía a las Islas del Rosario?", "El valor depende de la experiencia disponible, la fecha, las inclusiones y los cargos aplicables. Solicita la cotización final antes de pagar."],
